...
//apt install nodejs -y;apt install npm -y;npm i colors; npm i request
...
try {
    ...
    console.log('check in directory ua.txt and http.txt.');
    process.exit();
}
...
console.log('FED HAS THE ATTACK SENT! Target:'+VarsDefinetions.Objetive+' Time:'+VarsDefinetions.time);
